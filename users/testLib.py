...
class RestTestCase(unittest.TestCase):
    ...
    serverToTest = "rocky-taiga-9329.herokuapp.com"
    ...
    def makeRequest(self, url, method="GET", data={ }):
        ...
        #print "IMHEREIMHEREIMHEREIMHEREIMHEREIMHEREIMHERE"

        self.conn.sock.settimeout(100.0) # Give time to the remote server to start and respond
        #print url + "ALMOSTALMOSTALMOSTALMOSTALMOSTALMOSTALMOST"
        resp = self.conn.getresponse()
        #print "NANANANANANANANANANANANANANANNANANNNA"
        data_string = "<unknown"
        try:
            if printHeaders:
                print "  "
            ...
            if resp.status == 200:
                ...
                #print "DONEDONEDONDENONDEONDOENDDONDEDEONDONDE"
                return data
            else:
